...
<template>
    <Head :title="cv.full_name + ' এর সিভি'" />
    <div class="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl w-full bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 border-b-2 border-blue-400 pb-2 mb-4">সারসংক্ষেপ</h2>
                <p class="text-gray-700">{{ cv.summary }}</p>
            </div>

            <div v-if="cv.education?.length" class="mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 border-b-2 border-blue-400 pb-2 mb-4">শিক্ষাগত যোগ্যতা</h2>
                <ul class="space-y-4">
            ...
            <div v-if="cv.experience?.length" class="mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 border-b-2 border-blue-400 pb-2 mb-4">কাজের অভিজ্ঞতা</h2>
                <ul class="space-y-4">
            ...
            <div v-if="cv.skills?.length" class="mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 border-b-2 border-blue-400 pb-2 mb-4">দক্ষতা</h2>
            ...
            <div class="mt-8 text-center text-gray-500 text-sm">
                Laravel ও Vue.js দিয়ে তৈরি একটি অনলাইন সিভি।
            </div>
        </div>
    </div>
</template>
